...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		// Обработка дополнительного изображения
		...
		if (isset($this->request->post['image2']) && is_file(DIR_IMAGE . $this->request->post['image2'])) {
			$data['thumb_image2'] = $this->model_tool_image->resize($this->request->post['image2'], 100, 100);
		} elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['image2'])) {
			$data['thumb_image2'] = $this->model_tool_image->resize($category_info['image2'], 100, 100);
		} else {
