...
class __TwigTemplate_92b62786114e1d7a413dc218a811bf41c974fd8a555f1f9000a23a6863fcf282 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "                <img
                    id=\"";
            // line 51
            echo twig_replace_filter(twig_lower_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 51)), [" " => "-"]);
            echo "-image\"
                    src=\"";
            // line 52
