...
class __TwigTemplate_611e22411e3e93586a956a946253c9ceff04fc0b004b551da4dfac50de3eb717 extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "                                </div>
                                <div class=\"catalog_product_item_review\">
                                    <div>
                                        <img src=\"../../assets/img/star.png\" alt=\"Звезда\">
                                        <span>";
                // line 106
                echo twig_get_attribute($this->env, $this->source, $context["product"], "rating", [], "any", false, false, false, 106);
                echo "</span>
                                    </div>
                                    <div>
                                        <img src=\"../../assets/img/chat.png\" alt=\"Чат\">
                                        <span>";
                // line 110
                echo twig_get_attribute($this->env, $this->source, $context["product"], "reviews", [], "any", false, false, false, 110);
                echo " отзывов</span>
                                    </div>
                                </div>
...
document.querySelectorAll('.swiper-container').forEach(container => {
    const images = container.querySelectorAll('.swiper-image');
    const bullets = container.querySelectorAll('.local_swiper-pagination-bullet');
    ...
    bullets.forEach((bullet, index) => {
        bullet.addEventListener('click', () => {
            ...
            bullets.forEach(b => b.classList.remove('local_swiper-pagination-bullet-active'));
...
";
    ...
    {
        return array (  344 => 149,  316 => 123,  312 => 121,  300 => 115,  296 => 114,  289 => 110,  282 => 106,  276 => 102,  267 => 100,  263 => 99,  258 => 96,  247 => 94,  243 => 93,  237 => 92,  229 => 89,  225 => 88,  220 => 87,  216 => 86,  213 => 85,  211 => 84,  207 => 82,  203 => 80,  194 => 77,  188 => 76,  183 => 75,  179 => 74,  176 => 73,  174 => 72,  171 => 71,  163 => 69,  161 => 68,  115 => 25,  109 => 21,  95 => 20,  89 => 16,  83 => 14,  75 => 12,  72 => 11,  66 => 9,  63 => 8,  46 => 7,  37 => 1,);
    }
